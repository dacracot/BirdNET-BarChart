		...
		<html lang="en">
			...
			<body>
				...
				<table style="width:100%">
					<tr>
						<td style="text-align: left; vertical-align: text-top;"><a href="birding.html"><img src="grfx/svg/bird.svg" alt="Refresh" width="36" height="36"/></a></td>
						...
						<td style="text-align: right; vertical-align: text-top;"><a href="help.html"><img src="grfx/svg/help.svg" alt="Help" width="24" height="24"/></a></td>
					</tr>
				</table>
