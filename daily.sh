...
ffmpeg -framerate 24 -pattern_type glob -i "${BARCHART_HOME}/web/grfx/lunar/snapshot-*.png" -c:v libx264 -profile:v high -crf 20 -pix_fmt yuv420p ${BARCHART_HOME}/web/grfx/lunar/dial.mp4
