...
do
	...
	if [[ $EXITCODE -eq 0 ]]
		then
		java -classpath ${XSLT_JAR} net.sf.saxon.Transform -s:${BARCHART_HOME}/sky/weather.xml -xsl:${BARCHART_HOME}/sky/weather.xsl > ${BARCHART_HOME}/sky/weather.sql
...
convert -pointsize 12 -fill black -draw "text 2,294 '${TIMESTAMP}'" ${BARCHART_HOME}/web/grfx/lunar/snapshot-${JULIAN}${HOUR}.png ${BARCHART_HOME}/web/grfx/lunar/snapshot-${JULIAN}${HOUR}.gif
rm -v ${BARCHART_HOME}/web/grfx/lunar/snapshot-${JULIAN}${HOUR}.png
