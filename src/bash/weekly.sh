...
gzip /home/tweet/${YEAR}-${MONTH}-${DAY}-afterDark.err
gzip /home/tweet/${YEAR}-${MONTH}-${DAY}-afterDark.out
gzip /home/tweet/${YEAR}-${MONTH}-${DAY}-beforeDawn.err
gzip /home/tweet/${YEAR}-${MONTH}-${DAY}-beforeDawn.out
df -h
DURATION=$SECONDS
